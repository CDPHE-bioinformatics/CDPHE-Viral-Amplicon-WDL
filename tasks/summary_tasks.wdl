...
task summarize_results {
    ...
    output {
        ...
        File wgs_clinisys_report_csv = "~{project_name}_wgs_clinisys_report.csv"
    }
...
task transfer_outputs {
    ...
    command <<<
        ...
        gsutil -m cp ~{wgs_clinisys_report_csv} ~{outdirpath}/summary_results/
    >>>
