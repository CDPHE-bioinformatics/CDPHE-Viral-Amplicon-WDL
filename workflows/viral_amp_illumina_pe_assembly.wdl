    ...
    if (transfer_results) {
      call post_assembly_tasks.transfer_outputs as transfer_outputs {
          input:
              ...
              fastqc_clean1_html = assess_quality_clean.fastqc1_html,
              fastqc_clean1_zip = assess_quality_clean.fastqc1_zip,
              fastqc_clean2_html = assess_quality_clean.fastqc2_html,
              fastqc_clean2_zip = assess_quality_clean.fastqc2_zip,
